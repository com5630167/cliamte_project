   ...
   var carsAndModels = {};
    ...
    /*var carsAndModels = {};
    carsAndModels['1'] = ['opt1','max','min','avg','opt2','su', 'fd', 'id','tr','gsl','wsdi','csdi','dtr','txx','tnx','txn','tnn','tn10p','tx10p','tn90p','tx90p'];
    carsAndModels['2'] = ['opt1','max','min','avg','opt2','rx1day', 'rx5day', 'sdii', 'r10mm','r20mm','rnnmm','cdd','cwd','r95ptot','r99ptot','prcptot'];
    ...
    function ChangeCarList() {
        ...
        while (modelList.length) {
            modelList.remove(0);
            $('#cindex optgroup').remove();
        }
        var cars = carsAndModels[selCar];
        if (cars) {
               
              var group = $('<optgroup label="' + cars[0] + '" />');
              
              for (var i = 1 ; i < 4; i++) {
                $('<option />').html(cars[i]).appendTo(group);
              };

              group.appendTo(modelList);

              var group2 = $('<optgroup label="' + cars[4] + '" />');
              
              for (var i = 5 ; i < cars.length; i++) {
                $('<option />').html(cars[i]).appendTo(group2);
              }; 
              group2.appendTo(modelList);
...
/////////////////////////////////////////////////////////////////////////// 
        ...
        $( "select" ).change(function (e) {
              ...
              //document.getElementById("GraphName").innerHTML=index;
